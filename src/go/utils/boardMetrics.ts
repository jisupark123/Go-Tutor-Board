...
export default class BoardMetrics {
  ...
  // 바둑판 좌표 -> Canvas 좌표 변환
  static toCanvasCoords(boardSize: number, dimension: number, coordinate: Coordinate): [number, number] {
  ...
  // Canvas 좌표 -> 바둑판 좌표 변환
  static toBoardCoords(canvasY: number, canvasX: number, boardSize: number, dimension: number): [number, number] {
